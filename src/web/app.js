...
(function () {
  ...
  function agentGuideCard() {
    ...
    return `<div class="howto">
      ...
      <div class="flow">
        ...
        ${arrow}
        ${step("s3", "3", "🔎", "布置研究任务", "先按<b>初稿 / 综述</b>，再按<b>少年司法 / 其他领域</b>路由。少年司法初稿会先读一批核心文献，再给你两张骨架卡（含每章准备怎么写；套不进原型就自建），你选择前不写全文；开工前还会问你要不要派子代理。")}
        ${arrow}
  ...
  const AG_PROMPTS = [
    "请用「论文初稿（少年司法版）」研究监督考察条件控制；先读几篇核心文献摸清现场并告诉我这题适合哪几类结构原型、要不要自建骨架，再给我两张完整骨架卡（含每章每节准备怎么写）并推荐一条，我选择前不要写全文。",
