...
- **AI写综述遵守的规约.md** —— AI 往综述库写回时必须遵守的规则摘要（原文只读、另存综合、标未核验、不覆盖你核验的、可删，并说明联网边界）。完整规约由应用维护，见文件内指路。
...
2. **原始资料与写回安全**：不得直接修改原始文献或 Zotero。只有用户明确要求、并通过工具自身的安全闸时，才能用 add_source 收 PDF / EPUB / DOCX / Markdown / TXT，或用建库 / 深索工具更新 PaperPiggy 索引。
   wiki 写回仅限综合层（save_synthesis / update_wiki_page / mark_stale），绝不覆盖用户人工核验过的页；删除只由用户在应用里做。
...
_FACTORY_HASHES = {
    ...
    "rely/README.md":                   {"8a596c19896e457c57437faa0d759049a319f16c",
                                             "b31c3884a02e6f21429f92856dea6b8bd4b3d23f"},   # v2 联网边界
    ...
    "rely/技能/写论文与综述.md":        {"5027f5d8e6c6837907e5ddbc294de7b2f10d5de3",
                                             ...
                                             "7ef669e2afd43e55a97a0091bbcdcab908aa6f5e"},   # v6 原始资料与索引安全边界
    ...
    "rely/AI写综述遵守的规约.md":       {"0e792f4d4c0b698d187d59623f835b76d6056d7d",
                                             "c5d41ca5ba5c44774e38d8b20bbe59695cc1459e"},   # v2 安全与联网边界（已掩码绝对路径）
}
